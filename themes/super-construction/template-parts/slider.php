...
<div id="featured-slider">
	<div class="cycle-slideshow <?php echo esc_attr( $overlay_class ); ?>" id="main-slider" <?php echo $slide_attributes_text; ?>>
		...
		foreach ( $slider_details as $slide ) :
			...
			$caption_position  = business_point_get_option('caption_position_'.$count);

			?>
			<article class="<?php echo esc_attr( $extra_class ); ?> caption-position-<?php echo esc_attr( $caption_position ); ?>" data-cycle-title="<?php echo esc_attr( $slide['title'] ); ?>"  data-cycle-url="<?php echo esc_url( $slide['url'] ); ?>"  data-cycle-excerpt="<?php echo esc_attr( $slide['excerpt'] ); ?>">
